...
class CelebrityGraph {
    ...
    fun testWeakPlebNetwork() = with(Graph()) {
        ...
        assertEquals(0.25516126843864884, newPleb.scores[pleb1])
        assertEquals(0.004499885043810381, newPleb.scores[celebrity])
        assertEquals(0.0, newPleb.scores[pleb2])
        ...
        assertEquals(0.25516126843864884, newPleb.scores[pleb1])
        assertEquals(0.00897952112221323, newPleb.scores[celebrity])
        assertEquals(0.25516126843864884, newPleb.scores[pleb2])
        assertEquals(0.0, newPleb.scores[pleb3])

        newPleb follows pleb3

        assertEquals(0.25516126843864884, newPleb.scores[pleb1])
        assertEquals(0.013438999353225234, newPleb.scores[celebrity])

        pleb3 follows pleb1

        assertEquals(0.2585129571068525, newPleb.scores[pleb1])
        assertEquals(0.013497443415107724, newPleb.scores[celebrity])

        newPleb follows pleb4

        assertEquals(0.2585129571068525, newPleb.scores[pleb1])
        assertEquals(0.0179365915151648, newPleb.scores[celebrity])

        newPleb follows pleb5

        assertEquals(0.2585129571068525, newPleb.scores[pleb1])
        assertEquals(0.022355763959079122, newPleb.scores[celebrity])

        newPleb follows pleb6

        assertEquals(0.2585129571068525, newPleb.scores[pleb1])
        assertEquals(0.02675505063500705, newPleb.scores[celebrity])

        newPleb follows pleb7

        assertEquals(0.2585129571068525, newPleb.scores[pleb1])
        assertEquals(0.031134541026618612, newPleb.scores[celebrity])
    }
