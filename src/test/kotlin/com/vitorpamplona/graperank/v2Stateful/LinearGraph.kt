...
class LinearGraph {
    ...
    fun test() = with(Graph()) {
        ...
        assertEquals(0.0, center.scores[minus4hops])
        assertEquals(0.0, center.scores[minus3hops])
        assertEquals(0.0, center.scores[minus2hops])
        ...
        assertEquals(0.0, center.scores[plus4hops])
        ...
        assertEquals(0.0, minus4hops.scores[center])
        assertEquals(0.0, minus4hops.scores[plus1hops])
        assertEquals(0.0, minus4hops.scores[plus2hops])
        assertEquals(0.0, minus4hops.scores[plus3hops])
        assertEquals(0.0, minus4hops.scores[plus4hops])

        makeObserver(plus4hops)

        assertEquals(0.0, plus4hops.scores[minus4hops])
        assertEquals(0.0, plus4hops.scores[minus3hops])
        assertEquals(0.0, plus4hops.scores[minus2hops])
        assertEquals(0.0, plus4hops.scores[minus1hops])
        assertEquals(0.0, plus4hops.scores[center])
        assertEquals(0.0, plus4hops.scores[plus1hops])
        assertEquals(0.0, plus4hops.scores[plus2hops])
